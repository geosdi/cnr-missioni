 ...
 */
@Immutable
@Component(value = "cnrMissioniEsteroEmail")
public class CNRMissioniEsteroEmail implements CNRMissioniEmail {

    @Value(value = "gpMailConfigurator{gp.mail.cnr.missioni_estero_email:@null}")
