 ...
 */
@Immutable
public class AddAnticipoPagamentoMessage extends CNRMissioniMessage {

    private final String cnrMissioniEmail;
    private final PDFBuilder anticipoPagamentoPDFBuilder;
    private final String missioneID;

    public AddAnticipoPagamentoMessage(String userName, String userSurname, String userEmail,
    ...
    public MissioniMailImplementor.NotificationMessageType getNotificationMessageType() {
        return MissioniMailImplementor.NotificationMessageType.AGGIUNGI_ANTICIPO_PAGAMENTO_MAIL_PROD;
    }
