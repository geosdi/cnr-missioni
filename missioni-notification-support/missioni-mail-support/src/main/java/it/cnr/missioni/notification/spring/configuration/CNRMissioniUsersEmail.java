 ...
 */
@Immutable
@Component(value = "cnrMissioniUsersEmail")
public class CNRMissioniUsersEmail implements CNRMissioniEmail {

    @Value(value = "gpMailConfigurator{gp.mail.cnr.missioni_users_email:@null}")
