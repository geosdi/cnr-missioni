...
import it.cnr.missioni.el.index.settings.MissioneIdIndexSettings;
 ...
 * @author Salvia Vito
 */
@Component(value = "missioneIdIndexCreator")
public class MissioneIdIndexCreator extends GPAbstractIndexCreator {

    @Override
    public GPIndexSettings getIndexSettings() {
        return MissioneIdIndexSettings.MISSIONE_ID_DOC_INDEX_SETTINGS.getValue();
    }
