...
public class SearchConstants {
	...
	//USER
    public final static String USER_FIELD_NOME = "user.anagrafica.nome";
    ...
    public static final String MISSIONE_FIELD_OGGETTO = "missione.oggetto";
    public static final String MISSIONE_FIELD_DATA_INSERIMENTO = "missione.dataInserimento";
    public static final String MISSIONE_FIELD_ID_USER = "missione.idUser";
