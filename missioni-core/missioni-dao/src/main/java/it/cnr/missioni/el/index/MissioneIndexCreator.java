...
public class MissioneIndexCreator extends GPAbstractIndexCreator {
    ...
    protected void preparePutMapping() throws Exception {
        XContentBuilder xContentBuilder = jsonBuilder()
                ...
                .field("type", "boolean")
                .endObject()
                .startObject("motivazioni")
                .field("type", "string")
                .endObject()
                .startObject("altreDisposizioni")
                .field("type", "string")
                .endObject()
                .startObject("oggetto")
                .field("type", "string")
                ...
                .field("type", "string")
                .endObject()
                .startObject("idUserSeguito")
                .field("type", "string")
                .endObject()
                .startObject("shortUserSeguito")
                .field("type", "string")
                .endObject()
                .startObject("motivazioneSeguito")
                .field("type", "string")
                .endObject()
                ...
                .field("type", "double")
                .endObject()
                .startObject("speseAlberghiere")
                .field("type", "boolean")
                .endObject()
                .startObject("speseViaggioDocumentato")
                .field("type", "boolean")
                .endObject()
                .startObject("speseViaggioTam")
                .field("type", "boolean")
                .endObject()
