...
public class QualificaUserDAO extends AbstractElasticSearchDAO<QualificaUser> implements IQualificaUserDAO {
    ...
    public IPageResult<QualificaUser> findQualificaUserByQuery(IQualificaUserSearchBuilder qualificaUserSearchBuilder)
        ...
        return super.find(new MultiFieldsSearch(qualificaUserSearchBuilder.getFieldSort(), SortOrder.ASC,qualificaUserSearchBuilder.getFrom(),size,qualificaUserSearchBuilder.getListAbstractBooleanSearch().toArray(new IBooleanSearch[qualificaUserSearchBuilder.getListAbstractBooleanSearch().size()])));
    }
