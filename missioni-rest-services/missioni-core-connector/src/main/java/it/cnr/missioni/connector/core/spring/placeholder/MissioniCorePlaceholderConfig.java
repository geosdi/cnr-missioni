 ...
 *
 */
package it.cnr.missioni.connector.core.spring.placeholder;
 ...
 */
@Configuration
class MissioniCorePlaceholderConfig {

    private static final MissioniCoreResourcesLoader placeholderResourcesLoader = new MissioniCoreResourcesLoader();
    ...
    public static PropertySourcesPlaceholderConfigurer oauth2CorePropertyConfigurer(
        ...
        corePC.setLocations(placeholderResourcesLoader.loadResources(
                gpConfigDataDir, missioniCoreFileProp));
