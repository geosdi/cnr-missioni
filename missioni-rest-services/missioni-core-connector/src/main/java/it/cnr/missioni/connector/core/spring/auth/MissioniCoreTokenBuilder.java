...
import static it.cnr.missioni.dropwizard.connector.api.spec.GrantTypeValues.CLIENT_CREDENTIALS;
 ...
 */
class MissioniCoreTokenBuilder extends BaseTokenBuilder {

    public MissioniCoreTokenBuilder(MissioniClientSettings theClientSettings,
            Client theClient) {
