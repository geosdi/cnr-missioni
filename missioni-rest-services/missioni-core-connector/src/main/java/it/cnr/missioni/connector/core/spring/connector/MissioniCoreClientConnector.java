...
//				.header(HttpHeaders.AUTHORIZATION, "bearer ".concat(accessToken))
	...
	//
	// @Override
	// public GetAuthorityResponse getAuthorities(Long accountID) throws
	// Exception {
	// String accessToken = super.createToken();
	//
	...
	//
	// @Override
	// public GetAuthoritiesResponseWS getAuthoritiesDetail(String
	// accountNaturalID)
	// throws Exception {
	// String accessToken = super.createToken();
	//
	...
	//
	// @Override
	// public Long getAccountProjectsCount(Long accountID, SearchRequest
	// request)
	// throws Exception {
	// String accessToken = super.createToken();
	//
	...
	//
	// @Override
	// public ShortAccountDTOContainer getAccountsToShareByProjectID(Long
	// projectID)
	// throws Exception {
	// String accessToken = super.createToken();
	//
	...
	//
	// @Override
	// public ProjectDTO getProjectWithRootFolders(Long projectID, Long
	// accountID)
	// throws Exception {
	// String accessToken = super.createToken();
	//
	...
	//
	// @Override
	// public GetDataSourceResponse getLayersDataSourceByProjectID(Long
	// projectID)
	// throws Exception {
	// String accessToken = super.createToken();
	//
	...
	//
	// @Override
	// public GuiComponentsPermissionMapData getAccountPermission(Long
	// accountID)
	// throws Exception {
	// String accessToken = super.createToken();
	//
