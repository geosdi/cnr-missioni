...
public class VeicoloCNRRestServiceResource implements VeicoloCNRRestService {
	 ...
	 */
	@Override
	public Response getVeicoloCNRByQuery(String stato, int from, int size) throws Exception {
		return Response.ok(this.veicoloCNRDelegate.getVeicoloCNRByQuery(stato, from, size)).build();
	}
