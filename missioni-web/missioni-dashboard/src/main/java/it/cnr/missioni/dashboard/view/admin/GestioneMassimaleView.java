    ...
    protected HorizontalLayout addActionButtons() {
        ...
        buttonNew.addClickListener(new Button.ClickListener() {
            ...
            public void buttonClick(ClickEvent event) {
                selectedMassimale = null;
                elencoMassimaleTable.select(null);
//				MassimaleWindow.open(new Massimale(), true,true,false);
                MassimaleWindow.getMassimaleWindow().withBean(new Massimale()).withIsAdmin(true).withEnabled(true).withModifica(false).build();
            }
        });
...
//				MassimaleWindow.open(selectedMassimale, true,true,true);
                MassimaleWindow.getMassimaleWindow().withBean(selectedMassimale).withIsAdmin(true).withEnabled(true).withModifica(true).build();
            }
        });
