 ...
 * @author Salvia Vito
 */
public interface ITipoMissioneForm extends IForm<Missione, ITipoMissioneForm> {
    class TipoMissioneForm extends IForm.FormAbstract<Missione, ITipoMissioneForm> implements ITipoMissioneForm {
        ...
        private TipoMissioneForm() {
        }

        public static ITipoMissioneForm getTipoMissioneForm() {
            return new TipoMissioneForm();
        }

        public ITipoMissioneForm build() {
        ...
        public void buildTab() {
            ...
            if (bean.isMissioneEstera()) {
                ...
                trattamentoMissioneEsteraField
                        .setValue(bean.getDatiMissioneEstera().getTrattamentoMissioneEsteraEnum());
            } else
        ...
        public Missione validate() throws CommitException, InvalidValueException {
            ...
            // reset dei valori in caos in cui si scelga prima missione estera e
            // poi
            // si cambi
            if (!bean.isMissioneEstera()) {
         ...
         */
        @Override
        protected ITipoMissioneForm self() {
            return this;
        }
