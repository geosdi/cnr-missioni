...
public final class ElencoFattureTable extends ITable.AbstractTable {
    ...
    public <T> void aggiornaTable(T lista) {
        ...
        if (lista != null) {
            ...
            setColumnHeaders("N.Fattura", "Data", "Tipologia Spesa", "Valuta", "Altro\\Descrizione", "Importo €");
            setId("numeroFattura");
    ...
    public <T> void aggiornaTableRiepilogo(T lista) {
        ...
        if (lista != null) {
            ...
            setColumnHeaders("N.Fattura", "Data", "Tipologia Spesa", "Valuta", "Altro\\Descrizione", "Importo €", "Importo Spettante €");
            setId("numeroFattura");
            Object[] properties = {"data", "numeroFattura"};
            boolean[] ordering = {false, false};
            sort(properties, ordering);
