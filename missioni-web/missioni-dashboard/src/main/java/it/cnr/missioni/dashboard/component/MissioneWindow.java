...
public class MissioneWindow extends Window {
	...
	private MissioneWindow(final Missione missione,boolean modifica,ElencoMissioniTable elencoMissioniTable) {
...
//					trattamentoMissioneEsteraField.validate();
					...
					Missione missione = beanItem.getBean();

						DashboardEventBus.post(new MissioneAction(missione,modifica,elencoMissioniTable));
					close();
	...
	public static void open(final Missione missione,boolean modifica,ElencoMissioniTable elencoMissioniTable) {
		...
		Window w = new MissioneWindow(missione,modifica,elencoMissioniTable);
