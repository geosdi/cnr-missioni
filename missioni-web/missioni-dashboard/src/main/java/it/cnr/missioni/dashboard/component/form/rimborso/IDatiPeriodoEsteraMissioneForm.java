 ...
 * @author Salvia Vito
 */
public interface IDatiPeriodoEsteraMissioneForm extends IForm<DatiMissioneEstera, IDatiPeriodoEsteraMissioneForm> {
     ...
     * @return
     */
    IDatiPeriodoEsteraMissioneForm withMissione(Missione missione);

    public class DatiPeriodoEsteraMissioneForm
            extends IForm.FormAbstract<DatiMissioneEstera, IDatiPeriodoEsteraMissioneForm>
            implements IDatiPeriodoEsteraMissioneForm {
        ...
        private DatiPeriodoEsteraMissioneForm() {
        }

        public static IDatiPeriodoEsteraMissioneForm getDatiPeriodoEsteraMissioneForm() {
            return new DatiPeriodoEsteraMissioneForm();
        }

        public IDatiPeriodoEsteraMissioneForm build() {
         ...
         * @return
         */
        public IDatiPeriodoEsteraMissioneForm withMissione(Missione missione) {
        ...
        public void addDateRange() {
            // Le date di attraversamento frontiera devono essere comprese tra
            // la
        ...
        public DatiMissioneEstera validate() throws CommitException, InvalidValueException {
            ...
            if (missione.isMissioneEstera()) {
                BeanItem<DatiMissioneEstera> beanItem = (BeanItem<DatiMissioneEstera>) getFieldGroup()
                        .getItemDataSource();
                datiMissioneEstera = beanItem.getBean();
                datiMissioneEstera.setAttraversamentoFrontieraAndata(
                        new DateTime(attraversamentoFrontieraAndataField.getValue()));
                datiMissioneEstera.setAttraversamentoFrontieraRitorno(
                        new DateTime(attraversamentoFrontieraRitornoField.getValue()));
         ...
         */
        @Override
        protected IDatiPeriodoEsteraMissioneForm self() {
            return this;
        }
