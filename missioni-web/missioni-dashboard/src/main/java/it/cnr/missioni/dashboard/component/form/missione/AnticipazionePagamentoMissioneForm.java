 ...
 * @author Salvia Vito
 */
public class AnticipazionePagamentoMissioneForm extends IForm.FormAbstract<DatiAnticipoPagamenti> {
	...
	public AnticipazionePagamentoMissioneForm(DatiAnticipoPagamenti datiAnticipoPagamenti, boolean isAdmin,
	...
	public void buildTab() {
		...
		speseMissioniAnticipateField = (TextField) getFieldGroup().buildAndBind("Altre Spese di Missione Anticipate",
