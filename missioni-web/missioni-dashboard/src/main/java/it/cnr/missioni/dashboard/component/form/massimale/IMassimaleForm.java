 ...
 * @author Salvia Vito
 */
public interface IMassimaleForm extends IForm<Massimale, IMassimaleForm> {

    class MassimaleForm extends IForm.FormAbstract<Massimale, IMassimaleForm>
            implements IMassimaleForm {
        ...
        private MassimaleForm() {
        }

        public static IMassimaleForm getMassimaleForm() {
            return new MassimaleForm();
        }

        public IMassimaleForm build() {
