 ...
 * @author Salvia Vito
 */
public interface IDatiPeriodoMissioneForm extends IForm<DatiPeriodoMissione, IDatiPeriodoMissioneForm> {
    class DatiPeriodoMissioneForm extends IForm.FormAbstract<DatiPeriodoMissione, IDatiPeriodoMissioneForm>
            implements IDatiPeriodoMissioneForm {
        ...
        private DatiPeriodoMissioneForm() {
        }

        public static IDatiPeriodoMissioneForm getDatiPeriodoMissioneForm() {
            return new DatiPeriodoMissioneForm();
        }

        public IDatiPeriodoMissioneForm build() {
         ...
         */
        @Override
        protected IDatiPeriodoMissioneForm self() {
            return this;
        }
    }
