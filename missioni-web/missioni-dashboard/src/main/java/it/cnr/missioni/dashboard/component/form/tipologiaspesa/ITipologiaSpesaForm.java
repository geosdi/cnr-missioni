 ...
 * @author Salvia Vito
 */
public interface ITipologiaSpesaForm extends IForm<TipologiaSpesa, ITipologiaSpesaForm> {
    public class TipologiaSpesaForm extends IForm.FormAbstract<TipologiaSpesa, ITipologiaSpesaForm>
            implements ITipologiaSpesaForm {
        ...
        private TipologiaSpesaForm() {
        }

        public static ITipologiaSpesaForm getTipologiaSpesaForm() {
            return new TipologiaSpesaForm();
        }

        public ITipologiaSpesaForm build() {
         ...
         */
        @Override
        protected ITipologiaSpesaForm self() {
            return this;
        }
