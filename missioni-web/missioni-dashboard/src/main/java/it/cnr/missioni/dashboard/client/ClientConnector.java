...
public class ClientConnector {
	 ...
	 * @throws Exception
	 */
	public static void recuperePasswordMail(String userName, String userSurname, String email, String password)
			throws Exception {
		missioniCoreClientConnector.sendRecuperaPasswordMail(userName, userSurname, email, password);
	}
