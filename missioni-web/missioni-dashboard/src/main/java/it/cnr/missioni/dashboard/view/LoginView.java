...
import it.cnr.missioni.dashboard.component.RegistrationWindow;
...
public class LoginView extends VerticalLayout {
    ...
    public LoginView() {
        ...
        Notification notification = new Notification(
                "Benvenuto nel modulo Missioni del CNR");
        notification
                .setDescription("<span>Per accedere è necessario essere registrati <span></span>");
    ...
    private Component buildFields() {
        ...
        signin.addClickListener(new ClickListener() {
            ...
            public void buttonClick(final ClickEvent event) {
                DashboardEventBus.post(new LoginRequest(username
